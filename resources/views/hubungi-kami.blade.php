...
<div style="height: 600px" class="mb5">
    <br>
<h1 class="text-center" style="color:#133E87"><b>Hubungi Kami</b></h1>
    <br>
    <div class="container" style="background-color:white; border-radius: 20px; width:40%;">
        <div class="container p-2 ps-4">
            <div class="row pt-3 mb-3">
                <div class="col" style="margin-left:50px">
                    <h5 style="color:#133E87">
                        <!-- NEW  -->
